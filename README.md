...
```shell
bash -c "$(curl -fsSL https://raw.githubusercontent.com/kenzierocks/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
bash -c "$(wget https://raw.githubusercontent.com/kenzierocks/oh-my-zsh/master/tools/install.sh -O -)"
```
...
```shell
export ZSH="$HOME/.dotfiles/oh-my-zsh"; bash -c "$(curl -fsSL https://raw.githubusercontent.com/kenzierocks/oh-my-zsh/master/tools/install.sh)"
```
